...
## Install
```sh
docker pull itmp/cronicle:latest
```

## Running
```sh
docker run --name cronicle --hostname localhost -p 3012:3012 itmp/cronicle:latest
```
...
docker run --name cronicle \
  ...
  --hostname localhost -p 3012:3012 itmp/cronicle:latest
```
...
> e.g `docker run --name cronicle --hostname cronicle-host -p 3012:3012 -e CRONICLE_base_app_url='http://cronicle-host:3012' itmp/cronicle:latest`
